...
california_housing_dataframe["capped_rooms_per_person"] = california_housing_dataframe["rooms_per_person"].apply(lambda x: min(5,x))
...
calibration_data = train_model(
    ...
    steps=500,
    batch_size=5,
    input_feature="capped_rooms_per_person"
)
